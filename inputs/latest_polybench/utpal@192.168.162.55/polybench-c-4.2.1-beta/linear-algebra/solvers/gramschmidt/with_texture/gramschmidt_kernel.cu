...
__global__ void kernel2(float A[1000][1200], float R[1200][1200], int c0)
{
    ...
    if (32 * b0 + t0 <= 999)
      {
        float surf_write_temp_0 = ((A[32 * b0 + t0][(c0 - 3597) / 5995] / R[(c0 - 3597) / 5995][(c0 - 3597) / 5995]));
        surf2Dwrite(surf_write_temp_0, surfRef_Q,  ((c0 - 3597) / 5995)  * sizeof(float),  (32 * b0 + t0) );
      };
}
...
__global__ void kernel4(float A[1000][1200], float R[1200][1200], int c0)
{
    ...
    if (115104 * b0 + 3597 * t0 + 2398 >= c0 && 76736 * b0 + 2398 * t0 + 1439999 >= c0 && 2 * c0 >= 191840 * b0 + 5995 * t0 + 5995)
      for (int c4 = t1; c4 <= ppcg_min(31, -32 * b1 + 999); c4 += 16)
        {
          float surf_temp_QB32wmwb1wawc4BBCsc0wdw1199Cwaw96wmwb0waw3wmwt0waw2B_s1;
          surf2Dread(&surf_temp_QB32wmwb1wawc4BBCsc0wdw1199Cwaw96wmwb0waw3wmwt0waw2B_s1, surfRef_Q, ((-c0 / 1199) + 96 * b0 + 3 * t0 + 2) * sizeof(float), 32 * b1 + c4);
          
          A[32 * b1 + c4][(c0 / 1199) - 64 * b0 - 2 * t0 - 2] = (A[32 * b1 + c4][(c0 / 1199) - 64 * b0 - 2 * t0 - 2] - ((surf_temp_QB32wmwb1wawc4BBCsc0wdw1199Cwaw96wmwb0waw3wmwt0waw2B_s1) * R[(-c0 / 1199) + 96 * b0 + 3 * t0 + 2][(c0 / 1199) - 64 * b0 - 2 * t0 - 2]));
        }
}
      ...
      for (int c2 = 0; c2 <= 992; c2 += 32) {
        if (115104 * b0 + 3597 * t0 + 1199 >= c0 && 76736 * b0 + 2398 * t0 + 1438800 >= c0 && 2 * c0 >= 191840 * b0 + 5995 * t0 + 3597)
          for (int c4 = 0; c4 <= ppcg_min(31, -c2 + 999); c4 += 1)
            {
              float surf_temp_QBc2wawc4BBCsc0wdw1199Cwaw96wmwb0waw3wmwt0waw1B_s1;
              surf2Dread(&surf_temp_QBc2wawc4BBCsc0wdw1199Cwaw96wmwb0waw3wmwt0waw1B_s1, surfRef_Q, ((-c0 / 1199) + 96 * b0 + 3 * t0 + 1) * sizeof(float), c2 + c4);
              
              R[(-c0 / 1199) + 96 * b0 + 3 * t0 + 1][(c0 / 1199) - 64 * b0 - 2 * t0 - 1] += ((surf_temp_QBc2wawc4BBCsc0wdw1199Cwaw96wmwb0waw3wmwt0waw1B_s1) * A[c2 + c4][(c0 / 1199) - 64 * b0 - 2 * t0 - 1]);
            }
        __syncthreads();
      }
}
