...
#define cudaCheckKernel() \
  do { \
    ...
    cudaMallocArray(&cuArr_A, &channelDesc_A, 2000, 2000);
    cudaMemcpyToArray(cuArr_A, 0, 0, A, (2000) * (2000) * sizeof(float), cudaMemcpyHostToDevice);
    ...
    cudaCheckReturn(cudaMemcpy(dev_y_2, y_2, (2000) * sizeof(float), cudaMemcpyHostToDevice));
    {
      dim3 k0_dimBlock(32);
      dim3 k0_dimGrid(63);
      kernel0 <<<k0_dimGrid, k0_dimBlock>>> (dev_x1, dev_y_1);
      cudaCheckKernel();
    }
    
    {
      dim3 k1_dimBlock(32);
      dim3 k1_dimGrid(63);
      kernel1 <<<k1_dimGrid, k1_dimBlock>>> (dev_x2, dev_y_2);
      cudaCheckKernel();
    }
