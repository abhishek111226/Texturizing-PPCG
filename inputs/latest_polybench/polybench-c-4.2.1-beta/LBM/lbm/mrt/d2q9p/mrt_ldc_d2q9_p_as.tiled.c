...
#pragma vector always
                    ...
                    if ((t1 == t3) && (32*t1 == 32*t2-_nY-31)) {
                        if ((_nY+31)%32 == 0) {
                            lbm_kernel(grid[ (32*t1+31) % 2][ _nY][ 0][0], grid[ (32*t1+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0][2], grid[ (32*t1+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0][4], grid[ (32*t1+31) % 2][ _nY][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t1+31) % 2][ _nY][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (32*t1+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t1+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t1+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (32*t1+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][0], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][2], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][4], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][1], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][3], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][5], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][6], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][8], &grid[( (32*t1+31) + 1) % 2][ _nY][ 0][7], ( (32*t1+31)), ( _nY), ( 0));;
                        }
                    }
                    ...
                    if ((t1 == t2) && (32*t1 == 32*t3-_nX-31)) {
                        if ((_nX+31)%32 == 0) {
                            lbm_kernel(grid[ (32*t1+31) % 2][ 0][ _nX][0], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ _nX][2], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ _nX][4], grid[ (32*t1+31) % 2][ 0][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][1], grid[ (32*t1+31) % 2][ 0][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][3], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][5], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][6], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][8], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][7], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][0], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][2], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][4], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][1], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][3], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][5], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][6], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][8], &grid[( (32*t1+31) + 1) % 2][ 0][ _nX][7], ( (32*t1+31)), ( 0), ( _nX));;
                        }
                    }
...
#pragma vector always
                    ...
                    if ((t1 == t3) && (t1 <= min(floord(_nTimesteps-32,32),t2-1)) && (t1 >= ceild(32*t2-_nY-30,32))) {
                        for (t6=32*t2; t6<=min(32*t2+31,32*t1+_nY+30); t6++) {
                            lbm_kernel(grid[ (32*t1+31) % 2][ (-32*t1+t6-31)][ 0][0], grid[ (32*t1+31) % 2][ (-32*t1+t6-31) == 0 ? 2 * _nY - 1 : (-32*t1+t6-31) - 1][ 0][2], grid[ (32*t1+31) % 2][ (-32*t1+t6-31) + 1 == 2 * _nY ? 0 : (-32*t1+t6-31) + 1][ 0][4], grid[ (32*t1+31) % 2][ (-32*t1+t6-31)][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t1+31) % 2][ (-32*t1+t6-31)][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (32*t1+31) % 2][ (-32*t1+t6-31) == 0 ? 2 * _nY - 1 : (-32*t1+t6-31) - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t1+31) % 2][ (-32*t1+t6-31) == 0 ? 2 * _nY - 1 : (-32*t1+t6-31) - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t1+31) % 2][ (-32*t1+t6-31) + 1 == 2 * _nY ? 0 : (-32*t1+t6-31) + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (32*t1+31) % 2][ (-32*t1+t6-31) + 1 == 2 * _nY ? 0 : (-32*t1+t6-31) + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][0], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][2], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][4], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][1], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][3], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][5], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][6], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][8], &grid[( (32*t1+31) + 1) % 2][ (-32*t1+t6-31)][ 0][7], ( (32*t1+31)), ( (-32*t1+t6-31)), ( 0));;
                        }
                        for (t6=32*t2; t6<=min(32*t2+31,32*t1+_nY+31); t6++) {
                            lbm_kernel(grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31)][ 0][0], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t1-t6+2*_nY+31) - 1][ 0][2], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t1-t6+2*_nY+31) + 1][ 0][4], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31)][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31)][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t1-t6+2*_nY+31) - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t1-t6+2*_nY+31) - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t1-t6+2*_nY+31) + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (32*t1+31) % 2][ (32*t1-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t1-t6+2*_nY+31) + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][0], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][2], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][4], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][1], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][3], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][5], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][6], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][8], &grid[( (32*t1+31) + 1) % 2][ (32*t1-t6+2*_nY+31)][ 0][7], ( (32*t1+31)), ( (32*t1-t6+2*_nY+31)), ( 0));;
                        }
                    }
...
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            lbm_kernel(grid[ (32*t1+31) % 2][ 0][ (-32*t1+t7-31)][0], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ (-32*t1+t7-31)][2], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ (-32*t1+t7-31)][4], grid[ (32*t1+31) % 2][ 0][ (-32*t1+t7-31) == 0 ? 2 * _nX - 1 : (-32*t1+t7-31) - 1][1], grid[ (32*t1+31) % 2][ 0][ (-32*t1+t7-31) + 1 == 2 * _nX ? 0 : (-32*t1+t7-31) + 1][3], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ (-32*t1+t7-31) == 0 ? 2 * _nX - 1 : (-32*t1+t7-31) - 1][5], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ (-32*t1+t7-31) + 1 == 2 * _nX ? 0 : (-32*t1+t7-31) + 1][6], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ (-32*t1+t7-31) == 0 ? 2 * _nX - 1 : (-32*t1+t7-31) - 1][8], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ (-32*t1+t7-31) + 1 == 2 * _nX ? 0 : (-32*t1+t7-31) + 1][7], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][0], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][2], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][4], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][1], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][3], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][5], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][6], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][8], &grid[( (32*t1+31) + 1) % 2][ 0][ (-32*t1+t7-31)][7], ( (32*t1+31)), ( 0), ( (-32*t1+t7-31)));;
                        }
                        lbv=32*t3;
...
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            lbm_kernel(grid[ (32*t1+31) % 2][ 0][ (32*t1-t7+2*_nX+31)][0], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ (32*t1-t7+2*_nX+31)][2], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ (32*t1-t7+2*_nX+31)][4], grid[ (32*t1+31) % 2][ 0][ (32*t1-t7+2*_nX+31) == 0 ? 2 * _nX - 1 : (32*t1-t7+2*_nX+31) - 1][1], grid[ (32*t1+31) % 2][ 0][ (32*t1-t7+2*_nX+31) + 1 == 2 * _nX ? 0 : (32*t1-t7+2*_nX+31) + 1][3], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ (32*t1-t7+2*_nX+31) == 0 ? 2 * _nX - 1 : (32*t1-t7+2*_nX+31) - 1][5], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ (32*t1-t7+2*_nX+31) + 1 == 2 * _nX ? 0 : (32*t1-t7+2*_nX+31) + 1][6], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ (32*t1-t7+2*_nX+31) == 0 ? 2 * _nX - 1 : (32*t1-t7+2*_nX+31) - 1][8], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ (32*t1-t7+2*_nX+31) + 1 == 2 * _nX ? 0 : (32*t1-t7+2*_nX+31) + 1][7], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][0], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][2], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][4], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][1], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][3], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][5], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][6], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][8], &grid[( (32*t1+31) + 1) % 2][ 0][ (32*t1-t7+2*_nX+31)][7], ( (32*t1+31)), ( 0), ( (32*t1-t7+2*_nX+31)));;
                        }
                    }
                    if ((t1 == t2) && (t1 == t3) && (t1 <= floord(_nTimesteps-32,32))) {
                        lbm_kernel(grid[ (32*t1+31) % 2][ 0][ 0][0], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ 0][2], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ 0][4], grid[ (32*t1+31) % 2][ 0][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t1+31) % 2][ 0][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t1+31) % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (32*t1+31) % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][0], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][2], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][4], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][1], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][3], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][5], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][6], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][8], &grid[( (32*t1+31) + 1) % 2][ 0][ 0][7], ( (32*t1+31)), ( 0), ( 0));;
                    }
                }
            }
        }
