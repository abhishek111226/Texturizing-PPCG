...
#pragma vector always
                    ...
                    if ((t1 == 2*t2) && (16*t1 == 32*t3-_nX)) {
                        if (t1%2 == 0) {
                            if ((16*t1+_nX)%32 == 0) {
                                lbm_kernel(grid[ 16*t1 % 2][ 0][ _nX][0], grid[ 16*t1 % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ _nX][2], grid[ 16*t1 % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ _nX][4], grid[ 16*t1 % 2][ 0][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][1], grid[ 16*t1 % 2][ 0][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][3], grid[ 16*t1 % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][5], grid[ 16*t1 % 2][ 0 == 0 ? 2 * _nY - 1 : 0 - 1][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][6], grid[ 16*t1 % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][8], grid[ 16*t1 % 2][ 0 + 1 == 2 * _nY ? 0 : 0 + 1][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][7], &grid[( 16*t1 + 1) % 2][ 0][ _nX][0], &grid[( 16*t1 + 1) % 2][ 0][ _nX][2], &grid[( 16*t1 + 1) % 2][ 0][ _nX][4], &grid[( 16*t1 + 1) % 2][ 0][ _nX][1], &grid[( 16*t1 + 1) % 2][ 0][ _nX][3], &grid[( 16*t1 + 1) % 2][ 0][ _nX][5], &grid[( 16*t1 + 1) % 2][ 0][ _nX][6], &grid[( 16*t1 + 1) % 2][ 0][ _nX][8], &grid[( 16*t1 + 1) % 2][ 0][ _nX][7], ( 16*t1), ( 0), ( _nX));;
                            }
                        }
                    }
                    if (32*t1 == 32*t2+32*t3-_nY-_nX-31) {
                        if ((_nY+_nX+31)%32 == 0) {
                            lbm_kernel(grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ _nX][0], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ _nX][2], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ _nX][4], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][1], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][3], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][5], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][6], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ _nX == 0 ? 2 * _nX - 1 : _nX - 1][8], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ _nX + 1 == 2 * _nX ? 0 : _nX + 1][7], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][0], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][2], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][4], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][1], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][3], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][5], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][6], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][8], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ _nX][7], ( (32*t1-32*t2+_nY+31)), ( _nY), ( _nX));;
                        }
                    }
...
#pragma vector always
                    ...
                    if ((t1 >= max(ceild(32*t2+32*t3-_nY+1,32),2*t3)) && (t2 <= floord(32*t3+_nY+30,32)) && (t2 >= t3+1) && (t3 <= floord(_nTimesteps-32,32))) {
                        for (t6=max(32*t2,-32*t1+32*t2+64*t3+31); t6<=min(min(32*t2+31,32*t3+_nY+30),-32*t1+32*t2+64*t3+62); t6++) {
                            lbm_kernel(grid[ (32*t3+31) % 2][ (-32*t3+t6-31)][ 0][0], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) == 0 ? 2 * _nY - 1 : (-32*t3+t6-31) - 1][ 0][2], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) + 1 == 2 * _nY ? 0 : (-32*t3+t6-31) + 1][ 0][4], grid[ (32*t3+31) % 2][ (-32*t3+t6-31)][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t3+31) % 2][ (-32*t3+t6-31)][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) == 0 ? 2 * _nY - 1 : (-32*t3+t6-31) - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) == 0 ? 2 * _nY - 1 : (-32*t3+t6-31) - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) + 1 == 2 * _nY ? 0 : (-32*t3+t6-31) + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) + 1 == 2 * _nY ? 0 : (-32*t3+t6-31) + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][0], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][2], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][4], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][1], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][3], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][5], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][6], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][8], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][7], ( (32*t3+31)), ( (-32*t3+t6-31)), ( 0));;
                        }
                        for (t6=max(32*t2,-32*t1+32*t2+64*t3+31); t6<=min(min(32*t2+31,32*t3+_nY+31),-32*t1+32*t2+64*t3+62); t6++) {
                            lbm_kernel(grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31)][ 0][0], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t3-t6+2*_nY+31) - 1][ 0][2], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t3-t6+2*_nY+31) + 1][ 0][4], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31)][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31)][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t3-t6+2*_nY+31) - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t3-t6+2*_nY+31) - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t3-t6+2*_nY+31) + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (32*t3+31) % 2][ (32*t3-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t3-t6+2*_nY+31) + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][0], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][2], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][4], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][1], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][3], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][5], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][6], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][8], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+2*_nY+31)][ 0][7], ( (32*t3+31)), ( (32*t3-t6+2*_nY+31)), ( 0));;
                        }
                    }
...
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            lbm_kernel(grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][0], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ (-32*t1+32*t2+t7-_nY-31)][2], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ (-32*t1+32*t2+t7-_nY-31)][4], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31) == 0 ? 2 * _nX - 1 : (-32*t1+32*t2+t7-_nY-31) - 1][1], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31) + 1 == 2 * _nX ? 0 : (-32*t1+32*t2+t7-_nY-31) + 1][3], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ (-32*t1+32*t2+t7-_nY-31) == 0 ? 2 * _nX - 1 : (-32*t1+32*t2+t7-_nY-31) - 1][5], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ (-32*t1+32*t2+t7-_nY-31) + 1 == 2 * _nX ? 0 : (-32*t1+32*t2+t7-_nY-31) + 1][6], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ (-32*t1+32*t2+t7-_nY-31) == 0 ? 2 * _nX - 1 : (-32*t1+32*t2+t7-_nY-31) - 1][8], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ (-32*t1+32*t2+t7-_nY-31) + 1 == 2 * _nX ? 0 : (-32*t1+32*t2+t7-_nY-31) + 1][7], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][0], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][2], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][4], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][1], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][3], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][5], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][6], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][8], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (-32*t1+32*t2+t7-_nY-31)][7], ( (32*t1-32*t2+_nY+31)), ( _nY), ( (-32*t1+32*t2+t7-_nY-31)));;
                        }
...
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            lbm_kernel(grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][0], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ (32*t1-32*t2-t7+_nY+2*_nX+31)][2], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ (32*t1-32*t2-t7+_nY+2*_nX+31)][4], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31) == 0 ? 2 * _nX - 1 : (32*t1-32*t2-t7+_nY+2*_nX+31) - 1][1], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31) + 1 == 2 * _nX ? 0 : (32*t1-32*t2-t7+_nY+2*_nX+31) + 1][3], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ (32*t1-32*t2-t7+_nY+2*_nX+31) == 0 ? 2 * _nX - 1 : (32*t1-32*t2-t7+_nY+2*_nX+31) - 1][5], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ (32*t1-32*t2-t7+_nY+2*_nX+31) + 1 == 2 * _nX ? 0 : (32*t1-32*t2-t7+_nY+2*_nX+31) + 1][6], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ (32*t1-32*t2-t7+_nY+2*_nX+31) == 0 ? 2 * _nX - 1 : (32*t1-32*t2-t7+_nY+2*_nX+31) - 1][8], grid[ (32*t1-32*t2+_nY+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ (32*t1-32*t2-t7+_nY+2*_nX+31) + 1 == 2 * _nX ? 0 : (32*t1-32*t2-t7+_nY+2*_nX+31) + 1][7], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][0], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][2], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][4], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][1], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][3], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][5], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][6], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][8], &grid[( (32*t1-32*t2+_nY+31) + 1) % 2][ _nY][ (32*t1-32*t2-t7+_nY+2*_nX+31)][7], ( (32*t1-32*t2+_nY+31)), ( _nY), ( (32*t1-32*t2-t7+_nY+2*_nX+31)));;
                        }
                    }
                    if ((t1 == 2*t3) && (t1 <= floord(_nTimesteps-32,16)) && (16*t1 == 32*t2-_nY)) {
                        if ((16*t1+31*_nY)%32 == 0) {
                            if (_nY%32 == 0) {
                                lbm_kernel(grid[ (16*t1+31) % 2][ _nY][ 0][0], grid[ (16*t1+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0][2], grid[ (16*t1+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0][4], grid[ (16*t1+31) % 2][ _nY][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (16*t1+31) % 2][ _nY][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][3], grid[ (16*t1+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (16*t1+31) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (16*t1+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][8], grid[ (16*t1+31) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][7], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][0], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][2], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][4], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][1], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][3], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][5], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][6], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][8], &grid[( (16*t1+31) + 1) % 2][ _nY][ 0][7], ( (16*t1+31)), ( _nY), ( 0));;
                            }
                        }
                    }
                }
