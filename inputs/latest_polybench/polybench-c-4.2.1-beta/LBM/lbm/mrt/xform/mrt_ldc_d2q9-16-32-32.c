      ...
      for (t2 = lbp; t2 <= ubp; t2++) {
        for (t3 = max(max(0, ceild(t1 + t2 - 3, 4)),
             ...
             t3 <= min(min(min(floord(_nTimesteps + _nX - 2, 32),
                       ...
                       floord(16 * t1 - 16 * t2 + _nY + _nX + 13, 32));
             t3++) {
          for (t4 = max(max(max(max(0, 8 * t1 + 8 * t2), 16 * t1 - 16 * t2 + 2),
                            32 * t2 - _nY + 1),
                        32 * t3 - _nX + 1);
            ...
            if (t4 % 2 == 0) {
              for (t5 = max(max(32 * t2, t4 + 2),
                            -16 * t1 + 16 * t2 + 2 * t4 - 15);
                   t5 <= min(min(32 * t2 + 31, -16 * t1 + 16 * t2 + 2 * t4),
                             t4 + _nY - 1);
                   t5++) {
                lbv = max(32 * t3, t4 + 1);
