...
int main(void) {
  ...
  if ((_nTimesteps >= 1) && (_nX >= 2) && (_nY >= 3)) {
    for (t1 = -1; t1 <= floord(_nTimesteps - 1, 16); t1++) {
      lbp = max(ceild(t1, 2), ceild(32 * t1 - _nTimesteps + 3, 32));
      ubp = min(floord(_nTimesteps + _nY - 2, 32),
                floord(16 * t1 + _nY + 14, 32));
#pragma omp parallel for private(lbv, ubv, t3, t4, t5, t6)
      for (t2 = lbp; t2 <= ubp; t2++) {
        for (t3 = max(max(0, ceild(t1 - 1, 2)), ceild(32 * t2 - _nY - 29, 32));
             t3 <= min(min(min(floord(_nTimesteps + _nX - 2, 32),
                               floord(16 * t1 + _nX + 30, 32)),
                           floord(32 * t2 + _nX + 28, 32)),
                       floord(32 * t1 - 32 * t2 + _nY + _nX + 29, 32));
             t3++) {
          for (t4 = max(max(max(max(0, 16 * t1), 32 * t1 - 32 * t2 + 2),
                            32 * t2 - _nY + 1),
                        32 * t3 - _nX + 1);
               t4 <= min(min(min(min(_nTimesteps - 1, 16 * t1 + 31),
                                 32 * t2 + 29),
                             32 * t3 + 30),
                         32 * t1 - 32 * t2 + _nY + 30);
               t4++) {
            ...
            if (t4 % 2 == 0) {
              for (t5 = max(max(32 * t2, t4 + 2),
                            -32 * t1 + 32 * t2 + 2 * t4 - 31);
                   t5 <= min(min(32 * t2 + 31, -32 * t1 + 32 * t2 + 2 * t4),
                             t4 + _nY - 1);
                   t5++) {
                lbv = max(32 * t3, t4 + 1);
