...
int main(void) {
  ...
  if ((_nTimesteps >= 1) && (_nX >= 2) && (_nY >= 2) && (_nZ >= 3)) {
    for (t1 = -1; t1 <= floord(_nTimesteps - 1, 16); t1++) {
      ...
      ubp = min(floord(_nTimesteps + _nZ - 2, 32),
                floord(16 * t1 + _nZ + 14, 32));
#pragma omp parallel for private(lbv, ubv, t3, t4, t5, t6, t7, t8)
      for (t2 = lbp; t2 <= ubp; t2++) {
        for (t3 = max(max(0, ceild(t1 - 1, 2)), ceild(32 * t2 - _nZ - 29, 32));
             t3 <= min(min(min(floord(_nTimesteps + _nY - 2, 32),
                               floord(16 * t1 + _nY + 30, 32)),
                           floord(32 * t2 + _nY + 28, 32)),
                       floord(32 * t1 - 32 * t2 + _nZ + _nY + 29, 32));
             t3++) {
          for (t4 = max(
                   max(max(0, ceild(t1 - 1, 2)), ceild(32 * t2 - _nZ - 29, 32)),
               ...
               t4 <= min(min(min(min(floord(_nTimesteps + _nX - 2, 32),
                         ...
                         floord(32 * t1 - 32 * t2 + _nZ + _nX + 29, 32));
               t4++) {
            for (t5 = max(max(max(max(max(0, 16 * t1), 32 * t1 - 32 * t2 + 2),
                                  32 * t2 - _nZ + 1),
                              32 * t3 - _nY + 1),
                          32 * t4 - _nX + 1);
                 t5 <= min(min(min(min(min(_nTimesteps - 1, 16 * t1 + 31),
                                       32 * t2 + 29),
                                   32 * t3 + 30),
                               32 * t4 + 30),
                           32 * t1 - 32 * t2 + _nZ + 30);
              ...
              if (t5 % 2 == 0) {
                for (t6 = max(max(32 * t2, t5 + 2),
                              -32 * t1 + 32 * t2 + 2 * t5 - 31);
                     t6 <= min(min(32 * t2 + 31, -32 * t1 + 32 * t2 + 2 * t5),
                               t5 + _nZ - 1);
                     t6++) {
