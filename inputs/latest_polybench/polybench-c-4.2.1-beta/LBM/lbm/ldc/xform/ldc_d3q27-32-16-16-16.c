        ...
        for (t3 = max(max(0, ceild(2 * t1 - t2 - 1, 2)),
          ...
          for (t4 = max(max(max(0, ceild(2 * t1 - t2 - 1, 2)),
               ...
               t4 <= min(min(min(min(floord(_nTimesteps + _nX - 2, 16),
                         ...
                         floord(32 * t1 - 32 * t2 + _nZ + _nX + 29, 16));
               t4++) {
            for (t5 = max(max(max(max(max(0, 16 * t1 - 8 * t2),
                                      32 * t1 - 32 * t2 + 2),
                                  16 * t2 - _nZ + 1),
                              16 * t3 - _nY + 1),
                          16 * t4 - _nX + 1);
                 t5 <= min(min(min(min(min(_nTimesteps - 1, 16 * t2 + 13),
                                       16 * t3 + 14),
                                   16 * t4 + 14),
                               16 * t1 - 8 * t2 + 23),
                           32 * t1 - 32 * t2 + _nZ + 30);
              ...
              if (t5 % 2 == 0) {
                for (t6 = max(max(16 * t2, t5 + 2),
                              -32 * t1 + 32 * t2 + 2 * t5 - 31);
                     t6 <= min(min(16 * t2 + 15, -32 * t1 + 32 * t2 + 2 * t5),
                               t5 + _nZ - 1);
                     t6++) {
