...
int main(void) {
  ...
  if ((_nTimesteps >= 1) && (_nX >= 2) && (_nY >= 2) && (_nZ >= 3)) {
    for (t1 = ceild(-_nZ - 22, 16); t1 <= floord(3 * _nTimesteps - 5, 16);
         t1++) {
      lbp = max(max(ceild(t1 - 1, 3), ceild(8 * t1 - _nTimesteps + 3, 8)),
                -t1 - 2);
      ubp = min(min(floord(-4 * t1 + _nTimesteps - 1, 4),
                    floord(4 * t1 + _nZ + 2, 12)),
                floord(_nTimesteps + _nZ - 2, 16));
      ...
      for (t2 = lbp; t2 <= ubp; t2++) {
        for (t3 = max(max(0, ceild(t1 + t2 - 3, 4)),
             ...
             t3 <= min(min(min(floord(_nTimesteps + _nY - 2, 16),
                           ...
                           floord(4 * t1 + 4 * t2 + _nY + 10, 16)),
                       floord(8 * t1 - 8 * t2 + _nZ + _nY + 5, 16));
             t3++) {
          for (t4 = max(max(max(0, ceild(t1 + t2 - 3, 4)),
               ...
               t4 <= min(min(min(min(floord(_nTimesteps + _nX - 2, 16),
                         ...
                         floord(8 * t1 - 8 * t2 + _nZ + _nX + 5, 16));
               t4++) {
            for (t5 = max(
                     max(max(max(max(0, 4 * t1 + 4 * t2), 8 * t1 - 8 * t2 + 2),
                             16 * t2 - _nZ + 1),
                         16 * t3 - _nY + 1),
                     16 * t4 - _nX + 1);
              ...
              if (t5 % 2 == 0) {
                for (t6 = max(max(16 * t2, t5 + 2),
                              -8 * t1 + 8 * t2 + 2 * t5 - 7);
                     t6 <= min(min(16 * t2 + 15, -8 * t1 + 8 * t2 + 2 * t5),
                               t5 + _nZ - 1);
                     t6++) {
