...
int main(void) {
  ...
  if ((_nTimesteps >= 1) && (_nX >= 2) && (_nY >= 2) && (_nZ >= 3)) {
    for (t1 = ceild(-3 * _nZ - 50, 32); t1 <= floord(5 * _nTimesteps - 11, 32);
         t1++) {
      lbp = max(max(ceild(-t1 - 4, 3), ceild(t1 - 3, 5)),
                ceild(8 * t1 - _nTimesteps + 3, 8));
      ubp = min(min(min(floord(8 * t1 + _nZ + 6, 8),
                        floord(-4 * t1 + _nTimesteps - 1, 12)),
                    floord(4 * t1 + _nZ + 2, 20)),
      ...
      for (t2 = lbp; t2 <= ubp; t2++) {
        for (t3 = max(max(0, ceild(t1 + 3 * t2 - 7, 8)),
             ...
             t3 <= min(min(min(floord(_nTimesteps + _nY - 2, 32),
                           ...
                           floord(4 * t1 + 12 * t2 + _nY + 18, 32)),
                       floord(8 * t1 - 8 * t2 + _nZ + _nY + 5, 32));
             t3++) {
          for (t4 = max(max(max(0, ceild(t1 + 3 * t2 - 7, 8)),
                            ceild(32 * t2 - _nZ - 29, 32)),
               ...
               t4 <= min(min(min(min(floord(_nTimesteps + _nX - 2, 32),
                         ...
                         floord(8 * t1 - 8 * t2 + _nZ + _nX + 5, 32));
               t4++) {
            for (t5 = max(
                     max(max(max(max(0, 4 * t1 + 12 * t2), 8 * t1 - 8 * t2 + 2),
                             32 * t2 - _nZ + 1),
                         32 * t3 - _nY + 1),
                     32 * t4 - _nX + 1);
              ...
              if (t5 % 2 == 0) {
                for (t6 = max(max(32 * t2, t5 + 2),
                              -8 * t1 + 8 * t2 + 2 * t5 - 7);
                     t6 <= min(min(32 * t2 + 31, -8 * t1 + 8 * t2 + 2 * t5),
                               t5 + _nZ - 1);
                     t6++) {
