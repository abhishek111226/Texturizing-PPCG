...
int main(void) {
  ...
  if ((_nTimesteps >= 1) && (_nX >= 2) && (_nY >= 2) && (_nZ >= 3)) {
    for (t1 = -1; t1 <= floord(5 * _nTimesteps + 3 * _nZ - 8, 32); t1++) {
      lbp = max(max(ceild(4 * t1, 5), ceild(16 * t1 - _nTimesteps + 1, 12)),
                ceild(32 * t1 - _nTimesteps + 3, 32));
      ubp = min(min(floord(4 * t1 + 4, 3), floord(_nTimesteps + _nZ - 2, 8)),
                floord(16 * t1 + _nZ + 14, 20));
      ...
      for (t2 = lbp; t2 <= ubp; t2++) {
        for (t3 = max(max(0, ceild(4 * t1 - 3 * t2 - 1, 2)),
             ...
             t3 <= min(min(min(floord(_nTimesteps + _nY - 2, 8),
                               floord(8 * t2 + _nY + 4, 8)),
                           floord(16 * t1 - 12 * t2 + _nY + 18, 8)),
                       floord(32 * t1 - 32 * t2 + _nZ + _nY + 29, 8));
             t3++) {
          for (t4 = max(max(max(0, ceild(4 * t1 - 3 * t2 - 1, 2)),
                            ceild(8 * t2 - _nZ - 5, 8)),
                        ceild(8 * t3 - _nY - 5, 8));
               t4 <= min(min(min(min(floord(_nTimesteps + _nX - 2, 8),
                         ...
                         floord(32 * t1 - 32 * t2 + _nZ + _nX + 29, 8));
               t4++) {
            for (t5 = max(max(max(max(max(0, 16 * t1 - 12 * t2),
                                      32 * t1 - 32 * t2 + 2),
                                  8 * t2 - _nZ + 1),
                              8 * t3 - _nY + 1),
                          8 * t4 - _nX + 1);
              ...
              if (t5 % 2 == 0) {
                for (t6 = max(max(8 * t2, t5 + 2),
                              -32 * t1 + 32 * t2 + 2 * t5 - 31);
                     t6 <= min(min(8 * t2 + 7, -32 * t1 + 32 * t2 + 2 * t5),
                               t5 + _nZ - 1);
                     t6++) {
