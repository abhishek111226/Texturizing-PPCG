...
int main(void) {
    ...
    if ((_nTimesteps >= 1) && (_nX >= 1) && (_nY >= 1)) {
        for (t1=0; t1<=min(floord(32*floord(_nTimesteps+31,32)+123*_nTimesteps+31*_nY-155,1984),floord(2097024*floord(_nTimesteps+31,32)+65532*_nTimesteps+32705*_nY-163769,2097024)); t1++) {
            lbp=max(ceild(t1,2),ceild(32*t1-_nTimesteps+1,32));
            ubp=min(min(floord(2*_nTimesteps+_nY-2,64),floord(64*t1+_nY+62,128)),t1);
            #pragma omp parallel for private(lbv,ubv,t3,t4,t5,t6,t7)
            for (t2=lbp; t2<=ubp; t2++) {
                for (t3=t1-t2; t3<=min(floord(2*_nTimesteps+_nX-2,64),floord(64*t1-64*t2+_nX+62,64)); t3++) {
                    ...
                    if ((_nX >= 2) && (t1 <= floord(128*t2-_nY,64)) && (t2 <= floord(64*t3+_nY+60,64)) && (t2 >= ceild(64*t3+_nY-_nX+1,64))) {
                        if (_nY%2 == 0) {
...
#pragma vector always
                    ...
                    if ((_nX >= 2) && (64*t1 == 128*t2-_nY-62) && (64*t1 == 128*t3+_nY+62)) {
                        if ((3*_nY+2)%4 == 0) {
                            if ((64*t1+127*_nY+66)%128 == 0) {
                                lbm_kernel(grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2)][ 0][0], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0][2], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0][4], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ ((64*t1-_nY+62)/4) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][0], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][2], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][4], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][1], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][3], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][5], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][6], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][8], &grid[( ((64*t1-_nY+62)/4) + 1) % 2][ (_nY/2)][ 0][7], ( ((64*t1-_nY+62)/4)), ( (_nY/2)), ( 0));;
                            }
                        }
                    }
                    if ((_nX == 1) && (t1 == t2+t3) && (t1 <= floord(128*t2-_nY,64))) {
                        if (_nY%2 == 0) {
                    ...
                    if ((_nY >= 2) && (t1 <= floord(64*t2+64*t3-_nX,64)) && (t2 <= floord(64*t3+_nY-_nX-1,64)) && (t2 >= ceild(64*t3-_nX-60,64))) {
                        if (_nX%2 == 0) {
                    ...
                    if ((t1 <= floord(128*t2-_nY,64)) && (64*t2 == 64*t3+_nY-_nX)) {
                        if (_nY%2 == 0) {
                            if (_nX%2 == 0) {
                                if ((63*_nY+_nX)%64 == 0) {
                    ...
                    if ((_nX >= 2) && (_nY >= 2)) {
                        for (t4=max(max(ceild(64*t2-_nY+1,2),ceild(64*t3-_nX+1,2)),32*t1-32*t2); t4<=min(min(min(_nTimesteps-1,32*t2+30),32*t3+30),32*t1-32*t2+31); t4++) {
...
#pragma vector always
                    ...
                    if ((_nX >= 2) && (t1 == t2+t3) && (t1 <= min(floord(32*t2+_nTimesteps-32,32),2*t2-1)) && (t1 >= ceild(128*t2-_nY-61,64))) {
                        for (t6=32*t2; t6<=min(floord(64*t1-64*t2+_nY+61,2),32*t2+31); t6++) {
                            lbm_kernel(grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31)][ 0][0], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) == 0 ? _nY - 1 : (-32*t1+32*t2+t6-31) - 1][ 0][2], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) + 1 == _nY ? 0 : (-32*t1+32*t2+t6-31) + 1][ 0][4], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) == 0 ? _nY - 1 : (-32*t1+32*t2+t6-31) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) == 0 ? _nY - 1 : (-32*t1+32*t2+t6-31) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) + 1 == _nY ? 0 : (-32*t1+32*t2+t6-31) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) + 1 == _nY ? 0 : (-32*t1+32*t2+t6-31) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][0], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][2], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][4], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][1], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][3], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][5], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][6], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][8], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][7], ( (32*t1-32*t2+31)), ( (-32*t1+32*t2+t6-31)), ( 0));;
                        }
                        for (t6=32*t2; t6<=min(floord(64*t1-64*t2+_nY+62,2),32*t2+31); t6++) {
                            lbm_kernel(grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][0], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31) == 0 ? _nY - 1 : (32*t1-32*t2-t6+_nY+31) - 1][ 0][2], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31) + 1 == _nY ? 0 : (32*t1-32*t2-t6+_nY+31) + 1][ 0][4], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31) == 0 ? _nY - 1 : (32*t1-32*t2-t6+_nY+31) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31) == 0 ? _nY - 1 : (32*t1-32*t2-t6+_nY+31) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31) + 1 == _nY ? 0 : (32*t1-32*t2-t6+_nY+31) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+_nY+31) + 1 == _nY ? 0 : (32*t1-32*t2-t6+_nY+31) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][0], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][2], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][4], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][1], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][3], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][5], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][6], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][8], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+_nY+31)][ 0][7], ( (32*t1-32*t2+31)), ( (32*t1-32*t2-t6+_nY+31)), ( 0));;
                        }
                    }
                    if ((_nX == 1) && (_nY >= 2) && (t1 == t2+t3)) {
                        for (t4=max(ceild(64*t2-_nY+1,2),32*t1-32*t2); t4<=min(min(_nTimesteps-1,32*t2+30),32*t1-32*t2+31); t4++) {
                            for (t6=max(32*t2,t4); t6<=min(floord(2*t4+_nY-1,2),32*t2+31); t6++) {
