...
int main(void) {
    ...
    if ((_nTimesteps >= 1) && (_nX >= 1) && (_nY >= 1)) {
        for (t1=max(-1,ceild(-_nY-62,64)); t1<=floord(_nTimesteps-1,16); t1++) {
            lbp=ceild(t1,2);
            ubp=min(min(floord(2*_nTimesteps+_nY-2,64),floord(32*t1+_nY+31,64)),floord(64*t1+_nY+62,64));
            #pragma omp parallel for private(lbv,ubv,t3,t4,t5,t6,t7)
            for (t2=lbp; t2<=ubp; t2++) {
                for (t3=max(max(0,ceild(t1-1,2)),ceild(64*t2-_nY-62,64)); t3<=min(min(floord(2*_nTimesteps+_nX-2,64),floord(32*t1+_nX+62,64)),floord(64*t1-64*t2+_nY+_nX+62,64)); t3++) {
                    if ((_nX >= 2) && (_nY >= 2) && (t1 == 2*t2) && (t1 >= ceild(64*t3-_nX+1,32))) {
                        lbv=32*t3;
                        ubv=min(floord(32*t1+_nX-1,2),32*t3+31);
#pragma ivdep
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            if (t1%2 == 0) {
                                lbm_kernel(grid[ 16*t1 % 2][ 0][ (-16*t1+t7)][0], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (-16*t1+t7)][2], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (-16*t1+t7)][4], grid[ 16*t1 % 2][ 0][ (-16*t1+t7) == 0 ? _nX - 1 : (-16*t1+t7) - 1][1], grid[ 16*t1 % 2][ 0][ (-16*t1+t7) + 1 == _nX ? 0 : (-16*t1+t7) + 1][3], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (-16*t1+t7) == 0 ? _nX - 1 : (-16*t1+t7) - 1][5], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (-16*t1+t7) + 1 == _nX ? 0 : (-16*t1+t7) + 1][6], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (-16*t1+t7) == 0 ? _nX - 1 : (-16*t1+t7) - 1][8], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (-16*t1+t7) + 1 == _nX ? 0 : (-16*t1+t7) + 1][7], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][0], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][2], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][4], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][1], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][3], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][5], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][6], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][8], &grid[( 16*t1 + 1) % 2][ 0][ (-16*t1+t7)][7], ( 16*t1), ( 0), ( (-16*t1+t7)));;
                            }
                        }
                        lbv=max(32*t3,16*t1+1);
                        ubv=min(floord(32*t1+_nX,2),32*t3+31);
#pragma ivdep
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            if (t1%2 == 0) {
                                lbm_kernel(grid[ 16*t1 % 2][ 0][ (16*t1-t7+_nX)][0], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (16*t1-t7+_nX)][2], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (16*t1-t7+_nX)][4], grid[ 16*t1 % 2][ 0][ (16*t1-t7+_nX) == 0 ? _nX - 1 : (16*t1-t7+_nX) - 1][1], grid[ 16*t1 % 2][ 0][ (16*t1-t7+_nX) + 1 == _nX ? 0 : (16*t1-t7+_nX) + 1][3], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (16*t1-t7+_nX) == 0 ? _nX - 1 : (16*t1-t7+_nX) - 1][5], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (16*t1-t7+_nX) + 1 == _nX ? 0 : (16*t1-t7+_nX) + 1][6], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (16*t1-t7+_nX) == 0 ? _nX - 1 : (16*t1-t7+_nX) - 1][8], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (16*t1-t7+_nX) + 1 == _nX ? 0 : (16*t1-t7+_nX) + 1][7], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][0], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][2], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][4], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][1], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][3], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][5], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][6], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][8], &grid[( 16*t1 + 1) % 2][ 0][ (16*t1-t7+_nX)][7], ( 16*t1), ( 0), ( (16*t1-t7+_nX)));;
                            }
                        }
                    }
                    if ((_nX == 1) && (_nY >= 2) && (t1 == 2*t2) && (t1 == 2*t3)) {
                        if (t1%2 == 0) {
                            lbm_kernel(grid[ 16*t1 % 2][ 0][ 0][0], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0][2], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0][4], grid[ 16*t1 % 2][ 0][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ 16*t1 % 2][ 0][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( 16*t1 + 1) % 2][ 0][ 0][0], &grid[( 16*t1 + 1) % 2][ 0][ 0][2], &grid[( 16*t1 + 1) % 2][ 0][ 0][4], &grid[( 16*t1 + 1) % 2][ 0][ 0][1], &grid[( 16*t1 + 1) % 2][ 0][ 0][3], &grid[( 16*t1 + 1) % 2][ 0][ 0][5], &grid[( 16*t1 + 1) % 2][ 0][ 0][6], &grid[( 16*t1 + 1) % 2][ 0][ 0][8], &grid[( 16*t1 + 1) % 2][ 0][ 0][7], ( 16*t1), ( 0), ( 0));;
                        }
                    }
                    if ((_nX == 1) && (_nY == 1) && (t1 == 2*t2) && (t1 == 2*t3)) {
                        for (t4=16*t1; t4<=min(_nTimesteps-1,16*t1+31); t4++) {
                            if (t1%2 == 0) {
                    ...
                    if ((_nX >= 2) && (t1 <= floord(64*t2-_nY,32)) && (t2 <= floord(64*t3+_nY+60,64)) && (t2 >= max(ceild(_nY,64),ceild(64*t3+_nY-_nX+1,64)))) {
                        if (_nY%2 == 0) {
...
#pragma vector always
                    ...
                    if ((_nX >= 2) && (t1 == 2*t3+1) && (32*t1 == 64*t2-_nY-30)) {
                        if (_nY%2 == 0) {
                            if ((32*t1+63*_nY+34)%64 == 0) {
                                if ((_nY+62)%64 == 0) {
                                    lbm_kernel(grid[ (16*t1+15) % 2][ (_nY/2)][ 0][0], grid[ (16*t1+15) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0][2], grid[ (16*t1+15) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0][4], grid[ (16*t1+15) % 2][ (_nY/2)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (16*t1+15) % 2][ (_nY/2)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (16*t1+15) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (16*t1+15) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (16*t1+15) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (16*t1+15) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][0], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][2], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][4], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][1], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][3], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][5], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][6], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][8], &grid[( (16*t1+15) + 1) % 2][ (_nY/2)][ 0][7], ( (16*t1+15)), ( (_nY/2)), ( 0));;
                                }
                            }
                        }
                    }
                    if ((_nX == 1) && (t1 <= floord(64*t2-_nY,32)) && (t2 >= ceild(64*t3+_nY,64))) {
                        if (_nY%2 == 0) {
                    ...
                    if ((_nY >= 2) && (t1 <= min(floord(64*t3-_nX,32),floord(64*t2+64*t3-_nX-2,64))) && (t1 >= ceild(64*t2+64*t3-_nY-_nX-61,64)) && (t2 <= floord(64*t3+_nY-_nX-1,64)) && (t2 >= ceild(64*t3-_nX-60,64)) && (t3 >= ceild(_nX,64))) {
                        if (_nX%2 == 0) {
                            for (t6=max(max(ceild(64*t3-_nX,2),32*t2),-32*t1+32*t2+64*t3-_nX-31); t6<=min(min(floord(64*t3+_nY-_nX-1,2),32*t2+31),-32*t1+32*t2+64*t3-_nX); t6++) {
                            ...
                            for (t6=max(max(ceild(64*t3-_nX+2,2),32*t2),-32*t1+32*t2+64*t3-_nX-31); t6<=min(min(floord(64*t3+_nY-_nX,2),32*t2+31),-32*t1+32*t2+64*t3-_nX); t6++) {
                    ...
                    if ((_nY >= 2) && (t1 == 2*t2) && (32*t1 == 64*t3-_nX-62)) {
                        if (_nX%2 == 0) {
                            if (t1%2 == 0) {
                                if ((32*t1+_nX+62)%64 == 0) {
                                    lbm_kernel(grid[ (16*t1+31) % 2][ 0][ (_nX/2)][0], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (_nX/2)][2], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (_nX/2)][4], grid[ (16*t1+31) % 2][ 0][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][1], grid[ (16*t1+31) % 2][ 0][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][3], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][5], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][6], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][8], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][7], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][0], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][2], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][4], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][1], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][3], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][5], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][6], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][8], &grid[( (16*t1+31) + 1) % 2][ 0][ (_nX/2)][7], ( (16*t1+31)), ( 0), ( (_nX/2)));;
                                }
                            }
                        }
                    }
                    if ((_nY >= 2) && (t1 == 2*t2) && (32*t1 == 64*t3-_nX)) {
                        if (_nX%2 == 0) {
                            if (t1%2 == 0) {
                                if ((32*t1+_nX)%64 == 0) {
                                    lbm_kernel(grid[ 16*t1 % 2][ 0][ (_nX/2)][0], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (_nX/2)][2], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (_nX/2)][4], grid[ 16*t1 % 2][ 0][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][1], grid[ 16*t1 % 2][ 0][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][3], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][5], grid[ 16*t1 % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][6], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][8], grid[ 16*t1 % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][7], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][0], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][2], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][4], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][1], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][3], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][5], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][6], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][8], &grid[( 16*t1 + 1) % 2][ 0][ (_nX/2)][7], ( 16*t1), ( 0), ( (_nX/2)));;
                                }
                            }
                        }
                    }
                    if ((_nY == 1) && (t1 == 2*t2) && (t1 <= floord(64*t3-_nX,32))) {
                        if (_nX%2 == 0) {
                            if (t1%2 == 0) {
                    ...
                    if (64*t1 == 64*t2+64*t3-_nY-_nX-62) {
                        if (_nY%2 == 0) {
                            if (_nX%2 == 0) {
                                if ((_nY+_nX+62)%64 == 0) {
                                    lbm_kernel(grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ (_nX/2)][0], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ (_nX/2)][2], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ (_nX/2)][4], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][1], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][3], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][5], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][6], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ (_nX/2) == 0 ? _nX - 1 : (_nX/2) - 1][8], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ (_nX/2) + 1 == _nX ? 0 : (_nX/2) + 1][7], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][0], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][2], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][4], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][1], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][3], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][5], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][6], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][8], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ (_nX/2)][7], ( ((64*t1-64*t2+_nY+62)/2)), ( (_nY/2)), ( (_nX/2)));;
                                }
                            }
                        }
                    }
                    if ((t1 <= floord(64*t2-_nY,32)) && (t2 >= ceild(_nY,64)) && (64*t2 == 64*t3+_nY-_nX)) {
                        if (_nY%2 == 0) {
                            if (_nX%2 == 0) {
                                if ((63*_nY+_nX)%64 == 0) {
                    ...
                    if ((_nX >= 2) && (_nY >= 2)) {
                        for (t4=max(max(max(max(0,ceild(64*t2-_nY+1,2)),ceild(64*t3-_nX+1,2)),16*t1),32*t1-32*t2+1); t4<=min(min(min(min(floord(64*t1-64*t2+_nY+61,2),_nTimesteps-1),16*t1+31),32*t2+30),32*t3+30); t4++) {
                            for (t6=max(max(32*t2,t4),-32*t1+32*t2+2*t4-31); t6<=min(min(floord(2*t4+_nY-1,2),32*t2+31),-32*t1+32*t2+2*t4); t6++) {
                                lbv=max(32*t3,t4);
...
#pragma vector always
                            ...
                            for (t6=max(max(32*t2,t4+1),-32*t1+32*t2+2*t4-31); t6<=min(min(floord(2*t4+_nY,2),32*t2+31),-32*t1+32*t2+2*t4); t6++) {
                                lbv=max(32*t3,t4);
                                ubv=min(floord(2*t4+_nX-1,2),32*t3+31);
#pragma ivdep
#pragma vector always
...
#pragma vector always
                    ...
                    if ((_nX >= 2) && (t1 >= max(ceild(64*t2+64*t3-_nY+1,64),2*t3)) && (t2 <= floord(64*t3+_nY+61,64)) && (t2 >= t3+1) && (t3 <= floord(_nTimesteps-32,32))) {
                        for (t6=max(32*t2,-32*t1+32*t2+64*t3+31); t6<=min(min(floord(64*t3+_nY+61,2),32*t2+31),-32*t1+32*t2+64*t3+62); t6++) {
                            lbm_kernel(grid[ (32*t3+31) % 2][ (-32*t3+t6-31)][ 0][0], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) == 0 ? _nY - 1 : (-32*t3+t6-31) - 1][ 0][2], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) + 1 == _nY ? 0 : (-32*t3+t6-31) + 1][ 0][4], grid[ (32*t3+31) % 2][ (-32*t3+t6-31)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (32*t3+31) % 2][ (-32*t3+t6-31)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) == 0 ? _nY - 1 : (-32*t3+t6-31) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) == 0 ? _nY - 1 : (-32*t3+t6-31) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) + 1 == _nY ? 0 : (-32*t3+t6-31) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (32*t3+31) % 2][ (-32*t3+t6-31) + 1 == _nY ? 0 : (-32*t3+t6-31) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][0], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][2], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][4], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][1], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][3], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][5], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][6], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][8], &grid[( (32*t3+31) + 1) % 2][ (-32*t3+t6-31)][ 0][7], ( (32*t3+31)), ( (-32*t3+t6-31)), ( 0));;
                        }
                        for (t6=max(32*t2,-32*t1+32*t2+64*t3+31); t6<=min(min(floord(64*t3+_nY+62,2),32*t2+31),-32*t1+32*t2+64*t3+62); t6++) {
                            lbm_kernel(grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31)][ 0][0], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31) == 0 ? _nY - 1 : (32*t3-t6+_nY+31) - 1][ 0][2], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31) + 1 == _nY ? 0 : (32*t3-t6+_nY+31) + 1][ 0][4], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31) == 0 ? _nY - 1 : (32*t3-t6+_nY+31) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31) == 0 ? _nY - 1 : (32*t3-t6+_nY+31) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31) + 1 == _nY ? 0 : (32*t3-t6+_nY+31) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (32*t3+31) % 2][ (32*t3-t6+_nY+31) + 1 == _nY ? 0 : (32*t3-t6+_nY+31) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][0], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][2], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][4], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][1], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][3], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][5], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][6], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][8], &grid[( (32*t3+31) + 1) % 2][ (32*t3-t6+_nY+31)][ 0][7], ( (32*t3+31)), ( (32*t3-t6+_nY+31)), ( 0));;
                        }
                    }
                    if ((_nX == 1) && (_nY >= 2)) {
                        for (t4=max(max(max(ceild(64*t2-_nY+1,2),16*t1),32*t3),32*t1-32*t2+1); t4<=min(min(min(min(floord(64*t1-64*t2+_nY+61,2),_nTimesteps-1),16*t1+31),32*t2+30),32*t3+31); t4++) {
                            for (t6=max(max(32*t2,t4),-32*t1+32*t2+2*t4-31); t6<=min(min(floord(2*t4+_nY-1,2),32*t2+31),-32*t1+32*t2+2*t4); t6++) {
                    ...
                    if ((_nY >= 2) && (t1 == 2*t2) && (t1 <= min(floord(_nTimesteps-32,16),2*t3-2)) && (t1 >= ceild(64*t3-_nX-61,32))) {
                        lbv=32*t3;
                        ubv=min(floord(32*t1+_nX+61,2),32*t3+31);
#pragma ivdep
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            if (t1%2 == 0) {
                                lbm_kernel(grid[ (16*t1+31) % 2][ 0][ (-16*t1+t7-31)][0], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (-16*t1+t7-31)][2], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (-16*t1+t7-31)][4], grid[ (16*t1+31) % 2][ 0][ (-16*t1+t7-31) == 0 ? _nX - 1 : (-16*t1+t7-31) - 1][1], grid[ (16*t1+31) % 2][ 0][ (-16*t1+t7-31) + 1 == _nX ? 0 : (-16*t1+t7-31) + 1][3], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (-16*t1+t7-31) == 0 ? _nX - 1 : (-16*t1+t7-31) - 1][5], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (-16*t1+t7-31) + 1 == _nX ? 0 : (-16*t1+t7-31) + 1][6], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (-16*t1+t7-31) == 0 ? _nX - 1 : (-16*t1+t7-31) - 1][8], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (-16*t1+t7-31) + 1 == _nX ? 0 : (-16*t1+t7-31) + 1][7], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][0], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][2], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][4], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][1], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][3], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][5], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][6], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][8], &grid[( (16*t1+31) + 1) % 2][ 0][ (-16*t1+t7-31)][7], ( (16*t1+31)), ( 0), ( (-16*t1+t7-31)));;
                            }
                        }
                        lbv=32*t3;
                        ubv=min(floord(32*t1+_nX+62,2),32*t3+31);
#pragma ivdep
#pragma vector always
                        for (t7=lbv; t7<=ubv; t7++) {
                            if (t1%2 == 0) {
                                lbm_kernel(grid[ (16*t1+31) % 2][ 0][ (16*t1-t7+_nX+31)][0], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (16*t1-t7+_nX+31)][2], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (16*t1-t7+_nX+31)][4], grid[ (16*t1+31) % 2][ 0][ (16*t1-t7+_nX+31) == 0 ? _nX - 1 : (16*t1-t7+_nX+31) - 1][1], grid[ (16*t1+31) % 2][ 0][ (16*t1-t7+_nX+31) + 1 == _nX ? 0 : (16*t1-t7+_nX+31) + 1][3], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (16*t1-t7+_nX+31) == 0 ? _nX - 1 : (16*t1-t7+_nX+31) - 1][5], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ (16*t1-t7+_nX+31) + 1 == _nX ? 0 : (16*t1-t7+_nX+31) + 1][6], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (16*t1-t7+_nX+31) == 0 ? _nX - 1 : (16*t1-t7+_nX+31) - 1][8], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ (16*t1-t7+_nX+31) + 1 == _nX ? 0 : (16*t1-t7+_nX+31) + 1][7], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][0], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][2], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][4], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][1], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][3], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][5], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][6], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][8], &grid[( (16*t1+31) + 1) % 2][ 0][ (16*t1-t7+_nX+31)][7], ( (16*t1+31)), ( 0), ( (16*t1-t7+_nX+31)));;
                            }
                        }
                    }
                    if ((_nY >= 2) && (t1 == 2*t2) && (t1 == 2*t3) && (t1 <= floord(_nTimesteps-32,16))) {
                        if (t1%2 == 0) {
                            lbm_kernel(grid[ (16*t1+31) % 2][ 0][ 0][0], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0][2], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0][4], grid[ (16*t1+31) % 2][ 0][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (16*t1+31) % 2][ 0][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][0], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][2], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][4], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][1], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][3], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][5], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][6], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][8], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][7], ( (16*t1+31)), ( 0), ( 0));;
                        }
                    }
                    if ((_nX >= 2) && (_nY == 1) && (t1 == 2*t2)) {
                        for (t4=max(ceild(64*t3-_nX+1,2),16*t1); t4<=min(min(_nTimesteps-1,16*t1+31),32*t3+30); t4++) {
                            lbv=max(32*t3,t4);
                            ubv=min(floord(2*t4+_nX-1,2),32*t3+31);
#pragma ivdep
#pragma vector always
...
#pragma vector always
                    ...
                    if ((_nX >= 2) && (_nY == 1) && (t1 == 2*t2) && (t1 == 2*t3) && (t1 <= floord(_nTimesteps-32,16))) {
                        if (t1%2 == 0) {
                            lbm_kernel(grid[ (16*t1+31) % 2][ 0][ 0][0], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0][2], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0][4], grid[ (16*t1+31) % 2][ 0][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (16*t1+31) % 2][ 0][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (16*t1+31) % 2][ 0 == 0 ? _nY - 1 : 0 - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (16*t1+31) % 2][ 0 + 1 == _nY ? 0 : 0 + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][0], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][2], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][4], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][1], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][3], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][5], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][6], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][8], &grid[( (16*t1+31) + 1) % 2][ 0][ 0][7], ( (16*t1+31)), ( 0), ( 0));;
                        }
                    }
                    if ((_nX >= 2) && (t1 <= min(min(floord(64*t2-_nY,32),floord(64*t2+2*_nTimesteps-_nY-64,64)),floord(64*t2+64*t3-_nY-2,64))) && (t1 >= ceild(64*t2+64*t3-_nY-_nX-61,64))) {
                        if (_nY%2 == 0) {
                            lbv=max(ceild(64*t1-64*t2+_nY+62,2),32*t3);
                            ubv=min(floord(64*t1-64*t2+_nY+_nX+61,2),32*t3+31);
#pragma ivdep
#pragma vector always
                            for (t7=lbv; t7<=ubv; t7++) {
                                lbm_kernel(grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][0], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][2], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][4], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2) == 0 ? _nX - 1 : ((-64*t1+64*t2+2*t7-_nY-62)/2) - 1][1], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2) + 1 == _nX ? 0 : ((-64*t1+64*t2+2*t7-_nY-62)/2) + 1][3], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ ((-64*t1+64*t2+2*t7-_nY-62)/2) == 0 ? _nX - 1 : ((-64*t1+64*t2+2*t7-_nY-62)/2) - 1][5], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ ((-64*t1+64*t2+2*t7-_nY-62)/2) + 1 == _nX ? 0 : ((-64*t1+64*t2+2*t7-_nY-62)/2) + 1][6], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ ((-64*t1+64*t2+2*t7-_nY-62)/2) == 0 ? _nX - 1 : ((-64*t1+64*t2+2*t7-_nY-62)/2) - 1][8], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ ((-64*t1+64*t2+2*t7-_nY-62)/2) + 1 == _nX ? 0 : ((-64*t1+64*t2+2*t7-_nY-62)/2) + 1][7], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][0], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][2], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][4], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][1], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][3], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][5], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][6], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][8], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((-64*t1+64*t2+2*t7-_nY-62)/2)][7], ( ((64*t1-64*t2+_nY+62)/2)), ( (_nY/2)), ( ((-64*t1+64*t2+2*t7-_nY-62)/2)));;
                            }
                            lbv=max(ceild(64*t1-64*t2+_nY+64,2),32*t3);
                            ubv=min(floord(64*t1-64*t2+_nY+_nX+62,2),32*t3+31);
#pragma ivdep
#pragma vector always
                            for (t7=lbv; t7<=ubv; t7++) {
                                lbm_kernel(grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][0], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][2], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][4], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) == 0 ? _nX - 1 : ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) - 1][1], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) + 1 == _nX ? 0 : ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) + 1][3], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) == 0 ? _nX - 1 : ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) - 1][5], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) + 1 == _nX ? 0 : ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) + 1][6], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) == 0 ? _nX - 1 : ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) - 1][8], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) + 1 == _nX ? 0 : ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2) + 1][7], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][0], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][2], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][4], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][1], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][3], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][5], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][6], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][8], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)][7], ( ((64*t1-64*t2+_nY+62)/2)), ( (_nY/2)), ( ((64*t1-64*t2-2*t7+_nY+2*_nX+62)/2)));;
                            }
                        }
                    }
                    if ((_nX >= 2) && (t1 == 2*t3) && (t1 <= floord(_nTimesteps-32,16)) && (32*t1 == 64*t2-_nY)) {
                        if (_nY%2 == 0) {
                            if ((32*t1+63*_nY)%64 == 0) {
                                if (_nY%64 == 0) {
                                    lbm_kernel(grid[ (16*t1+31) % 2][ (_nY/2)][ 0][0], grid[ (16*t1+31) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0][2], grid[ (16*t1+31) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0][4], grid[ (16*t1+31) % 2][ (_nY/2)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ (16*t1+31) % 2][ (_nY/2)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ (16*t1+31) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ (16*t1+31) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ (16*t1+31) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ (16*t1+31) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][0], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][2], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][4], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][1], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][3], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][5], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][6], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][8], &grid[( (16*t1+31) + 1) % 2][ (_nY/2)][ 0][7], ( (16*t1+31)), ( (_nY/2)), ( 0));;
                                }
                            }
                        }
                    }
                    if ((_nX == 1) && (t1 <= min(min(floord(64*t2-_nY,32),floord(64*t2+64*t3-_nY,64)),floord(64*t2+2*_nTimesteps-_nY-64,64)))) {
                        if (_nY%2 == 0) {
                            lbm_kernel(grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ 0][0], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0][2], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0][4], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ 0 == 0 ? _nX - 1 : 0 - 1][1], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2)][ 0 + 1 == _nX ? 0 : 0 + 1][3], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 == 0 ? _nX - 1 : 0 - 1][5], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) == 0 ? _nY - 1 : (_nY/2) - 1][ 0 + 1 == _nX ? 0 : 0 + 1][6], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 == 0 ? _nX - 1 : 0 - 1][8], grid[ ((64*t1-64*t2+_nY+62)/2) % 2][ (_nY/2) + 1 == _nY ? 0 : (_nY/2) + 1][ 0 + 1 == _nX ? 0 : 0 + 1][7], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][0], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][2], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][4], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][1], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][3], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][5], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][6], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][8], &grid[( ((64*t1-64*t2+_nY+62)/2) + 1) % 2][ (_nY/2)][ 0][7], ( ((64*t1-64*t2+_nY+62)/2)), ( (_nY/2)), ( 0));;
                        }
                    }
                }
            }
