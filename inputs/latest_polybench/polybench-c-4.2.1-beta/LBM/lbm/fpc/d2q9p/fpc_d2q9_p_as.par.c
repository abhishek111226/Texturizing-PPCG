                    ...
                    if ((32*t1 == 64*t2-_nY-31) && (32*t1 == 64*t3+_nY+31)) {
                        if ((_nY+1)%2 == 0) {
                            if ((32*t1+63*_nY+33)%64 == 0) {
                                lbm_kernel(grid[ ((32*t1-_nY+31)/2) % 2][ _nY][ 0][0], grid[ ((32*t1-_nY+31)/2) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0][3], grid[ ((32*t1-_nY+31)/2) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0][4], grid[ ((32*t1-_nY+31)/2) % 2][ _nY][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ ((32*t1-_nY+31)/2) % 2][ _nY][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][2], grid[ ((32*t1-_nY+31)/2) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ ((32*t1-_nY+31)/2) % 2][ _nY == 0 ? 2 * _nY - 1 : _nY - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ ((32*t1-_nY+31)/2) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][7], grid[ ((32*t1-_nY+31)/2) % 2][ _nY + 1 == 2 * _nY ? 0 : _nY + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][8], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][0], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][3], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][4], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][1], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][2], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][5], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][6], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][7], &grid[( ((32*t1-_nY+31)/2) + 1) % 2][ _nY][ 0][8], ( ((32*t1-_nY+31)/2)), ( _nY), ( 0));;
                            }
                        }
                    }
...
#pragma vector always
                    ...
                    if ((t1 == t2+t3) && (t1 <= min(floord(32*t2+_nTimesteps-32,32),2*t2-1)) && (t1 >= ceild(64*t2-_nY-30,32))) {
                        for (t6=32*t2; t6<=min(32*t2+31,32*t1-32*t2+_nY+30); t6++) {
                            lbm_kernel(grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31)][ 0][0], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) == 0 ? 2 * _nY - 1 : (-32*t1+32*t2+t6-31) - 1][ 0][3], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) + 1 == 2 * _nY ? 0 : (-32*t1+32*t2+t6-31) + 1][ 0][4], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31)][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31)][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][2], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) == 0 ? 2 * _nY - 1 : (-32*t1+32*t2+t6-31) - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) == 0 ? 2 * _nY - 1 : (-32*t1+32*t2+t6-31) - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) + 1 == 2 * _nY ? 0 : (-32*t1+32*t2+t6-31) + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][7], grid[ (32*t1-32*t2+31) % 2][ (-32*t1+32*t2+t6-31) + 1 == 2 * _nY ? 0 : (-32*t1+32*t2+t6-31) + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][8], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][0], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][3], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][4], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][1], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][2], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][5], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][6], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][7], &grid[( (32*t1-32*t2+31) + 1) % 2][ (-32*t1+32*t2+t6-31)][ 0][8], ( (32*t1-32*t2+31)), ( (-32*t1+32*t2+t6-31)), ( 0));;
                        }
                        for (t6=32*t2; t6<=min(32*t2+31,32*t1-32*t2+_nY+31); t6++) {
                            lbm_kernel(grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][0], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t1-32*t2-t6+2*_nY+31) - 1][ 0][3], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t1-32*t2-t6+2*_nY+31) + 1][ 0][4], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][1], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][2], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t1-32*t2-t6+2*_nY+31) - 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][5], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31) == 0 ? 2 * _nY - 1 : (32*t1-32*t2-t6+2*_nY+31) - 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][6], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t1-32*t2-t6+2*_nY+31) + 1][ 0 == 0 ? 2 * _nX - 1 : 0 - 1][7], grid[ (32*t1-32*t2+31) % 2][ (32*t1-32*t2-t6+2*_nY+31) + 1 == 2 * _nY ? 0 : (32*t1-32*t2-t6+2*_nY+31) + 1][ 0 + 1 == 2 * _nX ? 0 : 0 + 1][8], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][0], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][3], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][4], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][1], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][2], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][5], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][6], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][7], &grid[( (32*t1-32*t2+31) + 1) % 2][ (32*t1-32*t2-t6+2*_nY+31)][ 0][8], ( (32*t1-32*t2+31)), ( (32*t1-32*t2-t6+2*_nY+31)), ( 0));;
                        }
                    }
