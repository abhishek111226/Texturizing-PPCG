...
#define cudaCheckKernel() \
  do { \
    ...
    cudaCheckReturn(cudaMalloc((void **) &dev_B, (1000) * (900) * sizeof(float)));
    cudaCheckReturn(cudaMalloc((void **) &dev_C, (900) * (1200) * sizeof(float)));
    cudaCheckReturn(cudaMalloc((void **) &dev_D, (1200) * (1100) * sizeof(float)));
    ...
    cudaCheckReturn(cudaMemcpy(dev_B, B, (1000) * (900) * sizeof(float), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_C, C, (900) * (1200) * sizeof(float), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_D, D, (1200) * (1100) * sizeof(float), cudaMemcpyHostToDevice));
    {
