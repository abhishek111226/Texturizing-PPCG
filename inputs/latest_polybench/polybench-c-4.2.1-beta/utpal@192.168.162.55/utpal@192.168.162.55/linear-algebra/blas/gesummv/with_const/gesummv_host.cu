...
#define cudaCheckKernel() \
  do { \
    ...
    cudaMallocArray(&cuArr_A, &channelDesc_A, 1300, 1300);
    ...
    cudaMallocArray(&cuArr_B, &channelDesc_B, 1300, 1300);
    ...
    cudaCheckReturn(cudaMemcpy(dev_x, x, (1300) * sizeof(float), cudaMemcpyHostToDevice));
    {
      dim3 k0_dimBlock(32);
      dim3 k0_dimGrid(41);
      kernel0 <<<k0_dimGrid, k0_dimBlock>>> (alpha, beta, dev_tmp, dev_x, dev_y);
      cudaCheckKernel();
    }
