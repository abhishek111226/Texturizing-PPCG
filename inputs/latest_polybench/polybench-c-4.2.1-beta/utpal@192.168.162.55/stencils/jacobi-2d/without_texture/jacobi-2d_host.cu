...
#define cudaCheckKernel() \
  do { \
    ...
    cudaCheckReturn(cudaMemcpy(A, dev_A, (1300) * (1300) * sizeof(float), cudaMemcpyDeviceToHost));
    cudaCheckReturn(cudaMemcpy(B, dev_B, (1300) * (1300) * sizeof(float), cudaMemcpyDeviceToHost));
