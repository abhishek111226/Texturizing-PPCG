...
#define cudaCheckKernel() \
  do { \
    ...
    cudaCheckReturn(cudaMalloc((void **) &dev_A, (n) * (4) * sizeof(int)));
    cudaCheckReturn(cudaMalloc((void **) &dev_B, (n) * (4) * sizeof(int)));
    
    
    cudaBindTexture(NULL,texRef_A, dev_A, (n) * (4) * sizeof(int));
    
    cudaBindTexture(NULL,texRef_B, dev_B, (n) * (4) * sizeof(int));
    
    cudaCheckReturn(cudaMemcpy(dev_A, A, (n) * (4) * sizeof(int), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_B, B, (n) * (4) * sizeof(int), cudaMemcpyHostToDevice));
    ...
    cudaCheckReturn(cudaMemcpy(A, dev_A, (n) * (4) * sizeof(int), cudaMemcpyDeviceToHost));
    cudaCheckReturn(cudaMemcpy(B, dev_B, (n) * (4) * sizeof(int), cudaMemcpyDeviceToHost));
