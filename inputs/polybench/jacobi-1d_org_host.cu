...
#define cudaCheckKernel() \
  do { \
    ...
    cudaBindTexture(NULL,texRef_A, dev_A, (n) * sizeof(double));
    
    cudaBindTexture(NULL,texRef_B, dev_B, (n) * sizeof(double));
    ...
    for (int c0 = 0; c0 < tsteps; c0 += 1) {
      {
        dim3 k0_dimBlock(32);
        dim3 k0_dimGrid(ppcg_min(32768, (n + 30) / 32));
      ...
      {
        dim3 k1_dimBlock(32);
        dim3 k1_dimGrid(ppcg_min(32768, (n + 30) / 32));
