...
extern "C" void heat3d(float*, int, int, int, float*);

extern "C" void heat3d_gold(float*, int, int, int, float*);
...
int main(int argc, char** argv) {
  ...
  heat3d((float*)input, height, width_y, width_x, (float*)output);

  heat3d_gold((float*)input, height, width_y, width_x, (float*)output_gold);
