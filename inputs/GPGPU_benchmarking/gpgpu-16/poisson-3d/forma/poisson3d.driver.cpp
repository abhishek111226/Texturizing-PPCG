...
extern "C" void poisson3d(float*, int, int, int, float*);

extern "C" void poisson3d_gold(float*, int, int, int, float*);
...
int main(int argc, char** argv) {
  ...
  poisson3d((float*)input, height, width_y, width_x, (float*)output);

  poisson3d_gold((float*)input, height, width_y, width_x, (float*)output_gold);
